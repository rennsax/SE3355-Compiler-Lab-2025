...
class MovInstruction(Instruction):
    ...
    def execute(self, state_table):
        ...
        # if self._arg0 == "(t497)":
        #     print("t496 "+str(state_table.get_mem_address(self._arg0)), arg0_val)
            
        # if self._arg1 == "(t126)":
        #     print("t126 "+str(state_table.get_mem_address(self._arg1)))
...
class AddInstruction(Instruction):
    ...
    def execute(self, state_table):
        ...
        # if self._arg1 == "%rsp":
        #     print("t547 "+str(state_table.get_operand(self._arg1)), arg0_val)
...
class SubInstruction(Instruction):
    ...
    def execute(self, state_table):
        ...
        if re.match(OperandEnum.Reg.value, self._arg1):
            ...
            # print(self._arg1 +str(state_table.load_reg(self._arg1)), arg0_val)
        elif re.match(OperandEnum.Imm.value, self._arg1):
            raise AssertionError("Should not use Imm as second operand")
        else:
            mem_add = state_table.get_mem_address(self._arg1)
...
class CmpInstruction(Instruction):
    ...
    def execute(self, state_table):
        ...
        # if (self._arg1 == "t251"):
        #     print("Cmp: %d %d" % (arg0_val, arg1_val))
...
class SetInstruction(Instruction):
        ...
        def execute(self, state_table):
            # Validate the condition
            # print("Set: "+self._condition.name)
